	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
		<div class="card card-body">
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
				<h1 class="h2">Ajouter un chantier</h1>
        ...
        <?=  flash("no_construction") ?>
        
        <div class="row">
            <div class="col-sm-6">
                <form class="form" action="<?= URLROOT ?>/admin_constructions/insert" role="form" method="post" enctype="multipart/form-data">
                    
                    <div class="form-group">
                        <label for="name">Nom <sup class="asterisk"><i class="fas fa-asterisk ml-2"></i></sup></label>
                        <input type="text" class="form-control form-control-lg <?= (isset($data['errors']['name']) && !empty($data['errors']['name'])) ? 'is-invalid' : '' ?>" id="name" name="name" placeholder="Nom du chantier" value="<?= $data['name'] ?>" required autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="textarea_count"  maxlength="255" class="form-control <?= (isset($data['errors']['comment']) && !empty($data['errors']['comment'])) ? 'is-invalid' : '' ?>" id="comment" name="comment"><?= $data['comment'] ?></textarea>
            ...
            <div class="col-sm-6">
                ...
                <img width="37%" src="<?= URLROOT ?>/images/constructions/default.png" alt="Image de profil">
            </div>
        </div>
    </main>
</div>
