	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
		<div class="card card-body">
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
				<h1 class="h2">Modifier catégories</h1>	
			...
			<div class="col-sm-12">
				<form class="form" action="<?= URLROOT ?>/admin_categories/update/<?= $data['id'] ?>" role="form" method="post">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text"  maxlength="255" class="form-control form-control-lg <?= (isset($data['errors']['description']) && !empty($data['errors']['description'])) ? 'is-invalid' : '' ?>" id="description" name="description" placeholder="Courte description..." value="<?= $data['description'] ?>">
					...
					<br>
					<p><i><sup class="asterisk"><i class="fas fa-asterisk ml-2"></i></sup> Champ obligatoire !</i></p>	
				</form>
			</div>
		</div>
	</main>
