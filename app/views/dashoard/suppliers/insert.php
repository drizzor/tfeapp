	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
		<div class="card card-body">
			...
			<form class="form" action="" role="form" method="post">
				<fieldset class="row">
					<legend>Info fournisseur</legend>
					<div class="col-md-12">
						<div class="form-group">
								<label for="name">Nom <sup class="asterisk"><i class="fas fa-asterisk ml-2"></i></sup></label>
								<input type="text" class="form-control form-control-lg <?= (isset($data['errors']['name']) && !empty($data['errors']['name'])) ? 'is-invalid' : '' ?>" id="name" name="name" placeholder="Nom du fournisseur" value="<?= $data['name'] ?>" autofocus required>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control dropdownField form-control-lg <?= (isset($data['errors']['city']) && !empty($data['errors']['city'])) ? 'is-invalid' : '' ?>" id="searchBox" name="city" placeholder="Indiquer ville ou code postal" autocomplete="off"  value="<?= $data['city'] ?>" required>
