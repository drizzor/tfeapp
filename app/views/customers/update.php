  ...
  <div class="container mt-5">
    <div class="card card-body">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2">Mettre à jour le client</h1>														
    ...
    <div class="col-md-12">        
        <p style="color:#d24e44">Attention, avant toutes modifications, soyez certain que cela soit nécessaire. Les précédentes factures attribuées au client resteront inchangées !</p>
        <form class="form" action="" role="form" method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-lg <?= (isset($data['errors']['zipcode']) && !empty($data['errors']['zipcode'])) ? 'is-invalid' : '' ?>" id="zipcode" name="zipcode" value="<?= $data['zipcode'] ?>" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-lg <?= (isset($data['errors']['city']) && !empty($data['errors']['city'])) ? 'is-invalid' : '' ?>" id="city" name="city" value="<?= $data['city'] ?>" required>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success btn-lg"><span class="fa fa-check"></span> Modifier</button>
            </div>
            <br>
